...
import CreateFollowing from "@/modules/Settings/Following/CreateFollowing";
...
const EditModal = ({
    ...
    const component = {
        ...
        [SettingsOptionEnum.FOLLOWING]: <Following editAcc selectFollowing={selectFollowing} />,
        [SettingsOptionEnum.ADD_FOLLOWING]: <CreateFollowing selectFollowing={selectFollowing} />,
        [SettingsOptionEnum.EDIT_FOLLOWING]: <CreateFollowing selectFollowing={selectFollowing}
                                                              edditedId={edditedId} />,
    };
    return (<>
            {component[value]}
